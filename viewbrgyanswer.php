    ...
    <thead>
        <tr class="table-bordered">  
            ...
            <th class="warning">View Brgy Answer</th>
               <th class="warning">Update Barangay Answer</th>
        ...
        <tr>
            ...
            <td>
             ...
             <td>
                <a href="updateallbrgy.php?user_id=<?php echo $row['user_id'];?>" class="btn btn-outline btn-info fa fa-profile">  Update Answer</a>
            </td>
