                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><input type="text" name="total_land_area" value="<?php echo $row['total_land_area'];?>" required></td>
                        </tr>
                    </tbody>
                </table>
            </div>
              ...
              <div class="panel-body" align="center">
                    ...
                    <p><b>Health Facility</b></p>
                      ...
                      <tbody align="center">
                        <tr>
                          ...
                          <td><input type="text" name="preschool" value="<?php echo $row['preschool'];?>" ></td>
                          <td><input type="text" name="elementary" value="<?php echo $row['elementary'];?>" ></td>
                        </tr>
                      </tbody>
                      <thead>
                        <tr>
                      ...
                      <tbody align="center">
                        <tr>
                          <td><input type="text" name="secondary" value="<?php echo $row['secondary'];?>" ></td>
                          <td><input type="text" name="vocational" value="<?php echo $row['vocational'];?>" ></td>
                          <td><input type="text" name="college_university" value="<?php echo $row['college_university'];?>" ></td>
                        </tr>
                      </tbody>
                    </table>
                </div>
                ...
                <div class="panel-body" align="center">
                    ...
                    <p><b>Service Facility</b></p>
                      ...
                      <tbody align="center">
                        <tr>
                          <td><input type="text" name="post_office" value="<?php echo $row['post_office'];?>" ></td>
                          <td><input type="text" name="market" value="<?php echo $row['market'];?>" ></td>
                        </tr>
                      </tbody>
                    </table>
                    ...
                    <p><b>Agricultural Facility</b></p>
                      ...
                      <tbody align="center">
                        <tr>
                          <td><input type="text" name="ricemill" value="<?php echo $row['ricemill'];?>"></td>
                          <td><input type="text" name="cornmill" value="<?php echo $row['cornmill'];?>" ></td>
                          <td><input type="text" name="feedmill" value="<?php echo $row['feedmill'];?>" ></td>
                          <td><input type="text" name="agricultural_market" value="<?php echo $row['agricultural_market'];?>" ></td>
                        </tr>
                      </tbody>
                    </table>
                    ...
                    <table>
                      ...
                      <tbody align="center">
                        <tr>
                          <td><input type="text" name="fertilizer" value="<?php echo $row['fertilizer'];?>" ></td>
                          <td><input type="text" name="pesticide" value="<?php echo $row['pesticide'];?>" ></td>
                          <td><input type="text" name="seeds" value="<?php echo $row['seeds'];?>"></td>
                          <td><input type="text" name="feeds" value="<?php echo $row['feeds'];?>" ></td>
                        </tr>
                      </tbody>
                    </table>
                  <div class="panel-body" align="center">
