...
// HEADER TITLE
    ...
    $this->CELL(0,0,' Resident housing Report',0,0,'C');
    $this->Ln();
...
function headerTable(){
 ...
 $this->Cell(40,10,' House Status',1,0,'C');
  $this->Cell(40,10,' Have Electricity',1,0,'C');
   $this->Cell(40,10,' Kind of Electricity',1,0,'C');
...
function viewTable($db){
    ...
    $this->Cell(40,10,$data->stat_house,1,0,'L');
    $this->Cell(40,10,$data->have_electricity,1,0,'L');
    $this->Cell(40,10,$data->source_electricity,1,0,'L');
    $this->Ln(10);
