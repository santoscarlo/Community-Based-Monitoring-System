...
// HEADER TITLE
    ...
    $this->CELL(0,0,' Resident Educational Report',0,0,'C');
    $this->Ln();
...
function headerTable(){
 ...
 $this->Cell(40,10,' Education Status',1,0,'C');
 $this->Cell(40,10,'Honors',1,0,'C');
  $this->Cell(40,10,' Registered Voters',1,0,'C');
   $this->Cell(40,10,' Latest Year Voted',1,0,'C');
...
function viewTable($db){
    ...
    $this->Cell(40,10,$data->educ_stat,1,0,'L');
    $this->Cell(40,10,$data->honors,1,0,'L');
    $this->Cell(40,10,$data->registered_voters,1,0,'L');
    $this->Cell(40,10,$data->latest_vote,1,0,'L');
    $this->Ln(10);
