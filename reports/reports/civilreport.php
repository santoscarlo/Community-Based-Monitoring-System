...
// HEADER TITLE
    ...
    $this->CELL(0,0,'Resident Civil Report',0,0,'C');
    $this->Ln();
...
function headerTable(){
 ...
 $this->Cell(40,10,'Civil Status',1,0,'C');
  $this->Cell(40,10,'Relation to Whom',1,0,'C');
   $this->Cell(40,10,' Name of Partner',1,0,'C');
...
function viewTable($db){
    ...
    $this->Cell(40,10,$data->gender,1,0,'L');
    $this->Cell(40,10,$data->civil_stat,1,0,'L');
    $this->Cell(40,10,$data->relation_whom,1,0,'L');
    $this->Cell(40,10,$data->name_partner,1,0,'L');
    $this->Ln(10);
